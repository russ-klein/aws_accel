 ...
 * whole or in part for internal business purposes only, provided         *
 * that this entire notice appears in all copies. In duplicating any part *
 * of this document, the recipient agrees to make every reasonable effort *
 * to prevent the unauthorized use and distribution of the proprietary    *
 * information.                                                           *
 *************************************************************************/
//***************************************************************************
// File: ac_wndo.h
...
#include <ac_ipl_int/ac_line_buffer.h>
#include <ac_ipl_int/ac_shift_reg.h>
#include <ac_ipl_int/ac_boundary.h>
